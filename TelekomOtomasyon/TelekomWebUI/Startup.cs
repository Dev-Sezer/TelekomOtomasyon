...
using TelekomService.Base;

namespace TelekomWebUI
{
    public class Startup
    {
        ...
        {
            services.AddMvc();
            services.AddDbContext<TelekomContext>(options => options.UseSqlServer("Server=SEZER\\MSSQLSERVER01;Database=Telekom;User Id=sa;Password=1;"));
